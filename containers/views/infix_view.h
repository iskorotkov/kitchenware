...
namespace containers::views
{
    ...
    template <typename TValue, typename TKey>
    typename infix_view<TValue, TKey>::iterator& infix_view<TValue, TKey>::iterator::operator++()
    {
    ...
    template <typename TValue, typename TKey>
    typename infix_view<TValue, TKey>::iterator infix_view<TValue, TKey>::iterator::operator++(int)
    {
